...
export const portfolioConfig: PortfolioConfig = {
  ...
  aboutInfo: {
    paragraphs: [
      "Data Scientist with 6+ years of industry experience in data science, data analytics, product management, business intelligence, database management and stakeholder engagement. Proven expertise in implementing Machine Learning frameworks using Dataiku Data Science Studio, statistical analysis, handling Big Data, and presenting compelling dashboards for evidence-based decision-making. I have an H1B Visa and I am looking for a full-time Data Scientist role in the USA."
    ],
  ...
  projectsInfo: [
    ...
    },
    {
      ...
      description: "Analyzed online retail transaction data to perform customer segmentation using RFM (Recency, Frequency, Monetary) analysis, generating business recommendations and marketing strategies tailored to different customer segments.",
      tech: ["Python", "Jupyter Notebook", "RFM Analysis", "Data Visualization"],
      github: "https://github.com/kishorkumarsridhar/Customer-Segmentation-using-RFM-analysis",
      showGithub: true,
      live: "",
      showLive: false,
    },
    {
      title: "Cohort Analysis using Python",
      description: "Performed cohort analysis to track daily active users, calculate retention curves for user cohorts, and analyze usage patterns based on user acquisition sources, providing visualized insights and business recommendations.",
      tech: ["Python", "Pandas", "NumPy", "Matplotlib", "Seaborn", "Cohort Analysis"],
      github: "https://github.com/kishorkumarsridhar/cohort-analysis-using-Python",
      showGithub: true,
      live: "",
      showLive: false,
    },
    {
      title: "Sales Forecasting using FB Prophet and SARIMAX",
      description: "Implemented time series forecasting using FB Prophet and SARIMAX models on UK-based online retail transaction data, evaluating model performance using Mean Absolute Percentage Error (MAPE) for accurate sales predictions.",
      tech: ["Python", "FB Prophet", "SARIMAX", "Time Series Forecasting", "Jupyter Notebook"],
      github: "https://github.com/kishorkumarsridhar/Sales-Forecasting-using-FB-Prophet-and-SARIMAX-models",
      showGithub: true,
      live: "",
      showLive: false,
    },
    {
      title: "Spatial Exploratory Data Analysis using Geopandas and Folium",
      description: "Conducted spatial EDA on robotic vacuum cleaner mission data to analyze geographic differences in robot usage and quantify data loss patterns, using Geopandas and Folium for geographic visualization and insights.",
      tech: ["Python", "Geopandas", "Folium", "Spatial Analysis", "Jupyter Notebook"],
      github: "https://github.com/kishorkumarsridhar/Spatial-Exploratory-Data-Analysis-using-Geopandas-and-Folium",
      showGithub: true,
      live: "",
      showLive: false,
    },
